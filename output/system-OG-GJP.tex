...
\title{OG-GJP 1.0}
\author{Olivier Giard / Gert-Jan Paulissen}
\begin{document}
\maketitle
\tableofcontents
...
Discussed on 4 Januray 2021.
\bigbreak
\subsection{No Gazilli}

\subsection{1M-1NT-2NT natral}

\subsection{Blackwood 3041}

\subsection{Leads and signals standard French}

So high is encouraging.
\bigbreak
\subsection{Two way checkback ("Double deux")}

Only after 1X-1M-1N, not after 1m-1\BH -1\BS .
\bigbreak
\subsection{Fit after our opening and intervention}

\
\dirtree{%%
 .1 1M-(2\BD). 
 .2 2NT.....\begin{minipage}[t]{0.8\textwidth}
four cards fit, limit or better
\end{minipage}. 
 .2 3\BD......\begin{minipage}[t]{0.8\textwidth}
three cards fit, limit or better
\end{minipage}. 
}
\bigbreak
\subsection{Landyk}

After our 1m opening and an intervention of 1NT, 2\BC\ shows the majors and the
rest is natural, i.e. no Texas.
\bigbreak
...
Both 2\BH\ and 2\BS\ show 5M and 4+ minor (VULN 5) less than a one level opening
bid. If your major suit is good you can open light. A minor of just four cards
...
\
\dirtree{%%
 .1 2M-.....\begin{minipage}[t]{0.8\textwidth}
5M with 4+m (VULN 5+m)
\end{minipage}. 
 .2 2\BS......\begin{minipage}[t]{0.8\textwidth}
5+\BS , NF
\end{minipage}. 
...
\end{minipage}. 
 .2 2NT.....\begin{minipage}[t]{0.8\textwidth}
asks partner to bid just his minor
\end{minipage}. 
 .2 3m......\begin{minipage}[t]{0.8\textwidth}
NAT, NF
\end{minipage}. 
